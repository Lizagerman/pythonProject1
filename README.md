...
теперь поддерживается чтение из .csv и .xlsx,
указать, какие функции добавлены (read_csv_transactions, read_excel_transactions),
какие зависимости появились (pandas, openpyxl).
